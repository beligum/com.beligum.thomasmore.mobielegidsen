 ...
 */
public class Restaurant extends HoReCa
{
    //-----CONSTANTS-----
    ...
    public Restaurant(String title, String address, String postalCode, String city, String phoneNumber, String email, String website, MapLocation location,
